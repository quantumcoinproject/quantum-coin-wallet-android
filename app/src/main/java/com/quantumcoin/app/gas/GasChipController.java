...
import com.quantumcoin.app.view.dialog.GasConfigDialog;
import com.quantumcoin.app.view.dialog.WaitDialog;
...
public final class GasChipController {
    ...
    private void onIconClick() {
        long limit = state.gasLimit != null ? state.gasLimit : kind.defaultGasLimit;
