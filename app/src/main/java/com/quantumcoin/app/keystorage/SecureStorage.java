 ...
 * v2 layered strongbox stack ({@link com.quantumcoin.app.strongbox.StrongboxFileCodec},
 * {@link com.quantumcoin.app.storage.AtomicSlotWriter},
 * {@link com.quantumcoin.app.strongbox.StrongboxPadding},
...
public class SecureStorage {
    ...
    public Map<String, String>[] buildWalletMaps(Context ctx) throws Exception {
        ...
        if (payload != null && payload.wallets != null) {
            for (Map.Entry<String, String> e : payload.wallets.entrySet()) {
                ...
                try {
                    com.quantumcoin.app.strongbox.WalletEntryCodec.WalletEntry entry =
                            com.quantumcoin.app.strongbox.WalletEntryCodec
                                    .decodeEntry(encoded);
    ...
    public void saveWallet(Context ctx, int index, String walletJson, String password)
        ...
        String encoded = com.quantumcoin.app.strongbox.WalletEntryCodec.encode(walletJson);
        StrongboxPayload payload = coordinator.getLivePayload();
    ...
    public String loadWallet(Context ctx, int index) throws Exception {
        ...
        return com.quantumcoin.app.strongbox.WalletEntryCodec.decode(encoded);
    }
