...
public class BackupPasswordDialog {
    ...
    private static void showCreateMode(final Context ctx, final JsonViewModel vm,
        ...
        // .newPassword.
        com.quantumcoin.app.security.CredentialIdentifier.apply(pwd,
                com.quantumcoin.app.security.CredentialIdentifier.Context.BACKUP_ENCRYPT,
        ...
        com.quantumcoin.app.security.CredentialIdentifier.apply(confirm,
                com.quantumcoin.app.security.CredentialIdentifier.Context.BACKUP_ENCRYPT,
                address, /*forCreation=*/true);
    ...
    public static void showRestore(final Context ctx, final JsonViewModel vm,
        ...
        com.quantumcoin.app.security.CredentialIdentifier.apply(pwd,
                com.quantumcoin.app.security.CredentialIdentifier.Context.BACKUP_DECRYPT,
