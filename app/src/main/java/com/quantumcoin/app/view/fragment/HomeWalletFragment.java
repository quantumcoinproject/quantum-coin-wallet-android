...
import com.quantumcoin.app.view.adapter.SeedWordAutoCompleteAdapter;
...
public class HomeWalletFragment extends Fragment {
     ...
     */
    private com.quantumcoin.app.asynctask.read.AccountBalanceRestTask
   ...
   // private TextView[] homeSeedWordsViewTextViews;
    ...
    public boolean handleBackPressed() {
        ...
        try {
            firstTime = !com.quantumcoin.app.viewmodel.KeyViewModel
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    com.quantumcoin.app.Logger.e(TAG, "backup export failed", e);
                                    getActivity().runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
    ...
    private void setSuppressNextResumeLock(boolean suppress) {
        try {
            android.app.Activity act = getActivity();
            if (act instanceof com.quantumcoin.app.view.activities.HomeActivity) {
                ((com.quantumcoin.app.view.activities.HomeActivity) act).setSuppressNextResumeLock(suppress);
            }
        } catch (Exception ignore) { }
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        boolean homeSeedCopyAvailable = com.quantumcoin.app.utils.SecureClipboard
        ...
        View.OnClickListener homeCopyClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.quantumcoin.app.utils.SecureClipboard.copySensitive(
     ...
     * a foreground {@link com.quantumcoin.app.view.dialog.WaitDialog}
                ...
                encryptWalletForBackup(backupPassword, new EncryptedReady() {
                    ...
                    public void onReady(String encryptedJson, String address) {
                        ...
                        try {
                            ...
                            intent.setType(com.quantumcoin.app.backup.CloudBackupManager.BACKUP_MIME_TYPE);
                            intent.putExtra(Intent.EXTRA_TITLE,
                                    com.quantumcoin.app.backup.CloudBackupManager.buildFilename(address));
    ...
    private void encryptWalletForBackup(final String backupPassword, final EncryptedReady onReady) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    final com.quantumcoin.app.backup.CloudBackupManager.EncryptedResult enc =
                    ...
                    com.quantumcoin.app.Logger.e(TAG, "encryptWalletForBackup failed", e);
                    getActivity().runOnUiThread(new Runnable() {
                        public void run() {
                            if (waitDlg != null) try { waitDlg.dismiss(); } catch (Throwable ignore) { }
                            String tmpl = jsonViewModel.getBackupFailedByLangValues();
    ...
    private void showRestoreFolderFilePicker(final Uri folderUri) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final com.quantumcoin.app.backup.CloudBackupManager.ScanOutcome scan =
                        com.quantumcoin.app.backup.CloudBackupManager
                                .scanQualifyingBackupsWithOutcome(ctx, folderUri);
                final List<com.quantumcoin.app.backup.CloudBackupManager.BackupCandidate> candidates =
                        scan.candidates;
                if (getActivity() == null) return;
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        ...
                        final List<com.quantumcoin.app.backup.CloudBackupManager.BackupCandidate> pending =
                                new ArrayList<>();
                        final List<String> restored = new ArrayList<>();
                        final List<String> alreadyExists = new ArrayList<>();
                        final List<String> skipped = new ArrayList<>();
                        for (com.quantumcoin.app.backup.CloudBackupManager.BackupCandidate c : candidates) {
                            if (c.address != null
                        ...
                        ensureStrongboxReadyForRestore(new Runnable() {
                            ...
                            public void run() {
                                ...
                                for (com.quantumcoin.app.backup.CloudBackupManager.BackupCandidate c : pending) {
    ...
    private void runBatchedRestorePass(
        ...
        com.quantumcoin.app.view.dialog.BackupPasswordDialog.showRestoreBatch(
                getContext(), jsonViewModel, remainingAddresses,
                new com.quantumcoin.app.view.dialog.BackupPasswordDialog.OnBatchPasswordListener() {
                    @Override
                    public void onPassword(String password,
                                           com.quantumcoin.app.view.dialog.BackupPasswordDialog.BatchDialogControl control) {
     ...
     * {@link com.quantumcoin.app.view.dialog.BackupPasswordDialog})
     * can legitimately differ from the device's strongbox
     * password (see {@link com.quantumcoin.app.backup.BackupExecutor}
    ...
    private void showStrongboxRestoreUnlockDialog(@NonNull final SecureStorage secureStorage,
        ...
        try {
            ...
            com.quantumcoin.app.view.dialog.UnlockDialogs.applyMandatory(
                    dialog, false);
     ...
     *  Honors {@link com.quantumcoin.app.security.UnlockAttemptLimiter}
    ...
    private void runStrongboxRestoreUnlock(
        ...
        final com.quantumcoin.app.view.dialog.WaitDialog.Handle waitHandle =
                com.quantumcoin.app.view.dialog.WaitDialog.showWithDetails(
                ...
                try {
                    com.quantumcoin.app.security.UnlockAttemptLimiter.Decision lim =
                            com.quantumcoin.app.security.UnlockAttemptLimiter
                                    .currentDecision(ctx);
                    if (lim.kind == com.quantumcoin.app.security
                    ...
                    com.quantumcoin.app.Logger.e(TAG, "restore strongbox unlock failed", e);
                }
    ...
    private void attemptBatchDecrypt(
            ...
            final com.quantumcoin.app.view.dialog.BackupPasswordDialog.BatchDialogControl control) {
        final Context ctx = getContext();
        if (ctx == null) return;
        ...
        final com.quantumcoin.app.view.dialog.WaitDialog.Handle overlay =
                com.quantumcoin.app.view.dialog.WaitDialog.showWithDetails(
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Iterator<com.quantumcoin.app.backup.CloudBackupManager.BackupCandidate> it =
                            pending.iterator();
                    while (it.hasNext()) {
                        final com.quantumcoin.app.backup.CloudBackupManager.BackupCandidate c = it.next();
                        ...
                        String cipher;
                        try {
                            cipher = com.quantumcoin.app.backup.CloudBackupManager
                        ...
                        com.quantumcoin.app.backup.CloudBackupManager.DecryptedWallet dw;
                        try {
                            dw = com.quantumcoin.app.backup.CloudBackupManager
                        ...
                        } catch (com.quantumcoin.app.keystorage.WrongPasswordException wpe) {
                            ...
                            GlobalMethods.ShowMessageDialog(getContext(),
                                    ...
                                    new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            // dialog and show it.
                                            for (com.quantumcoin.app.backup
    ...
    private void completeRestoreNavigation(final String indexKey) {
        ...
        if (restoreBootstrappedStrongbox
                && act instanceof com.quantumcoin.app.view.activities.HomeActivity) {
            restoreBootstrappedStrongbox = false;
            ((com.quantumcoin.app.view.activities.HomeActivity) act)
                    .requirePasswordReentryThenNavigate(new Runnable() {
                        @Override
        ...
        com.quantumcoin.app.view.dialog.BackupPasswordDialog.showRestore(getContext(), jsonViewModel,
                ...
                new com.quantumcoin.app.view.dialog.BackupPasswordDialog.OnPasswordAttemptListener() {
                    ...
                    public void onAttempt(String password,
                                          com.quantumcoin.app.view.dialog.BackupPasswordDialog.PasswordDialogControl control) {
    ...
    private void performRestoreFromUri(final Uri fileUri, final String backupPassword,
                                       final ProgressBar progressBar,
                                       final com.quantumcoin.app.view.dialog.BackupPasswordDialog.PasswordDialogControl control) {
        final AlertDialog waitDlg = com.quantumcoin.app.view.dialog.WaitDialog
                .show(getContext(), jsonViewModel.getWaitWalletOpenByLangValues());
        new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    ...
                    final com.quantumcoin.app.backup.CloudBackupManager.DecryptedWallet dw =
                            com.quantumcoin.app.backup.CloudBackupManager
                    ...
                    com.quantumcoin.app.Logger.e(TAG, "Restore decrypt failed", e);
