...
import com.quantumcoinwallet.app.strongbox.StrongboxFileCodec;
import com.quantumcoinwallet.app.strongbox.StrongboxPadding;
...
public final class UnlockCoordinator {
    ...
    public synchronized void persist(Context ctx, StrongboxPayload newPayload,
        ...
        com.quantumcoinwallet.app.security.UnlockAttemptLimiter.Decision decision =
                com.quantumcoinwallet.app.security.UnlockAttemptLimiter.currentDecision(ctx);
        if (decision.kind == com.quantumcoinwallet.app.security.UnlockAttemptLimiter
                .DecisionKind.LOCKED) {
        ...
        try {
            try {
                ...
                com.quantumcoinwallet.app.security.UnlockAttemptLimiter.recordFailure(ctx,
            ...
            com.quantumcoinwallet.app.security.UnlockAttemptLimiter.recordSuccess(ctx,
                    com.quantumcoinwallet.app.security.UnlockAttemptLimiter
                            .Channel.STRONGBOX_UNLOCK);
        } finally {
            Arrays.fill(derivedKey, (byte) 0);
