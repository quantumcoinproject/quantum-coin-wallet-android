...
public final class TransactionReviewDialog {
    ...
    public static AlertDialog show(final Context ctx,
        ...
        root.setBackgroundResource(
                com.quantumcoinwallet.app.R.drawable.center_container);
        ...
        int textColor = androidx.core.content.ContextCompat.getColor(
                ctx, com.quantumcoinwallet.app.R.color.colorCommon7);
        ...
        cancel.setBackgroundResource(
                com.quantumcoinwallet.app.R.drawable.button_network_cancel_selector);
        ...
        ok.setBackgroundResource(
                com.quantumcoinwallet.app.R.drawable.button_green_selector);
