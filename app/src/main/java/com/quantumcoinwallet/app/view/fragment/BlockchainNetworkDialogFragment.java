...
public class BlockchainNetworkDialogFragment extends DialogFragment {
     ...
     * {@link com.quantumcoinwallet.app.utils.NetworkPersistence#writeActiveIndex}.
    ...
    private void promptUnlockAndPersistActiveIndex(final int targetIndex,
                                                   final com.quantumcoinwallet.app.viewmodel.JsonViewModel vm) {
        final com.quantumcoinwallet.app.keystorage.SecureStorage secureStorage =
        ...
        if (secureStorage == null) {
            ...
            com.quantumcoinwallet.app.utils.PrefConnect.writeInteger(getContext(),
                    com.quantumcoinwallet.app.utils.PrefConnect.BLOCKCHAIN_NETWORK_ID_INDEX_KEY,
                    targetIndex);
        ...
        com.quantumcoinwallet.app.utils.GlobalMethods.focusAndShowKeyboard(pwd, dialog);
        try {
        ...
        unlockBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (password.isEmpty()) {
                    com.quantumcoinwallet.app.utils.GlobalMethods
