 ...
 * {@link com.quantumcoinwallet.app.api.read.ApiClient} stack. The
 * generated client only converts {@link java.io.IOException} into
 * {@link com.quantumcoinwallet.app.api.read.ApiException}; an
 ...
 *   {@link com.quantumcoinwallet.app.api.read.ApiException} so the
...
public class AccountBalanceRestTaskHardeningTest {
    ...
    private static String readSource() throws Exception {
        File f = new File("src/main/java/com/quantumcoinwallet/"
